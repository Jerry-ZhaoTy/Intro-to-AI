          ...
          #  value = -2
           # j = 0
            #for i in range (len(succ)):
             #   if Teeko2Player.Max_Value(self, succ[i], 0, drop_phase) > value:
              #      value = Teeko2Player.Max_Value(self, state, 0, drop_phase)
               #     j = i
       #      for row in range(5):
        #        for col in range(5):
         #           if state[row][col] != succ[j][row][col]:
          #            if state[row][col] == ' ':
       ...
       # else:
        #    value = -2
         #   j = 0
          #  for i in range (len(succ)):
           #     if Teeko2Player.Max_Value(self, succ[i], 0, drop_phase) > value:
            #        value = Teeko2Player.Max_Value(self, succ[i], 0, drop_phase)
             #       j = i
           # for row in range(5):
            #    for col in range(5):
             #       if state[row][col] != succ[j][row][col]:
    ...
    def Min_Value(self, state, depth, drop_phase):
        ...
        if depth >= 0:
            ...
            for i in range (len(succ)):
                ...
                b = max(b, Teeko2Player.Max_Value(self, succ[i], depth, drop_phase))
